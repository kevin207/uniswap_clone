const styles = {
  ...
  headTitle: "text-white font-poppins font-bold text-5xl tracking-wide",
  subTitle: "text-dim-white font-poppins font-medium mt-3 text-base",
  exchangeBoxWrapper: "mt-10 w-full flex justify-center",
  exchangeBox:
    "relative md:max-w-[700px] md:min-w-[500px] min-w-full max-w-full w-full gradient-border p-[2px] rounded-3xl",
  exchange:
  ...
  currencyButton:
    "flex flex-row items-center bg-site-dim2 py-2 px-4 rounded-xl font-poppins font-medium text-white",
  currencyList:
